...
function ResultsContent() {
  ...
  if (error || !analysis) {
    ...
    const rgb = analysis?.detected_color?.rgb || [0, 0, 0];
    const [r, g, b] = rgb;
    const levelDesc = getLevelDescription(analysis?.detected_color?.level ?? 7);
    const toneLabel = TONE_LABELS[analysis?.detected_color?.tone || 'N'] || analysis?.detected_color?.tone;
        ...
        <div style={styles.leftCol}>
          ...
          <div className="card" style={styles.resultCard}>
            <div className="card-header" style={styles.resultHeader}>
              <div>
                <h2 style={styles.resultTitle}>Upload Hair Analysis Results Analyze Hair</h2>
                <p style={styles.resultSubtitle}>
                   Hair Analysis
                </p>
              </div>
              <div className="badge badge-success">
                {Math.round((analysis.detected_color?.confidence || 0) * 100)}% confident
              </div>
            </div>
